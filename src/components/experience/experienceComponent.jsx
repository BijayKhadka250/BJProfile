        ...
        <Row id={id} type="flex" className='full-height-row' justify='center' gutter={24}>
            ...
            <Fade right duration={1500}>
                    ...
                    <Tabs defaultActiveKey="1" tabPosition={tabsPosition}>
                        <TabPane tab={<p >Perennia</p>} key={1}>
                            <h2>Front End Developer <span className='company-name'>@ Perennia</span></h2>
                        ...
                        <TabPane tab={<p >SMU</p>} key={2}>
                            <h2>Full-Stack Developer <span className='company-name'>@ SMU</span></h2>
                            <h4>May 2020 - September 2020</h4>
                            <ul className='work-list'>
                        ...
                        <TabPane tab={<p >Dunot</p>} key={3}>
                            <h2>Front End Developer<span className='company-name'>@ Dunot</span></h2>
