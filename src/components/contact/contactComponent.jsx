                    ...
                    <Row gutter={24} justify="center">
                        ...
                        <Row type="flex" justify="center" style={{marginTop: '1rem'}}>
                            ...
                            <Fade down duration={1500} delay={600}>
                                <Button className="social-icon " type='link' target='_blank' href="https://www.facebook.com/bijay.khadka.520/"><i className='fab fa-2x fa-facebook-square'></i></Button>
                            </Fade>
                            </Col>
                            <Col md={3} lg={3} sm={10} xs={10}  className='contact-icon-col'>
                                <Fade down duration={1500} delay={600}>
                                <Button className="social-icon " type='link' target='_blank' href="https://github.com/BijayKhadka250"><i className='fab fa-2x fa-github'></i></Button>
                            </Fade>
                            </Col>
                            <Col md={3} lg={3} sm={10} xs={10}  className='contact-icon-col'>
                                <Fade down duration={1500} delay={600}>
                                <Button className="social-icon " type='link' target='_blank' href="https://www.linkedin.com/in/bijaykhadka/"><i className="fab fa-2x fa-linkedin"></i></Button>
                            </Fade>
                            </Col>
